...
export default function RulesPanel({ onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center">
      <div className="glass max-w-xl w-full rounded-2xl p-6 relative max-h-[85vh] flex flex-col">
        ...
        <h2 className="text-sm font-semibold text-text-primary mb-1">Rules</h2>
        <p className="text-[10px] text-text-dim uppercase tracking-wider mb-3">
          High-level constraints that define the series
        </p>
